...
/**
 * RegexRenamer is a class that can be used for renaming path with regex and
 * replacer schema, this class is a class that implements {@link Function}, it can be
 ...
 *
 */
public class RegexRenamer implements Function<Path, Path> {
	...
	/**
	 * Initialize RegexRenamer with regex, replacer and decide either the regex
	 ...
	 */
	public RegexRenamer(String regex, String replacer,
